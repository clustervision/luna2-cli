...
from badluna.utils.presenter import Presenter
...
class Node():
    ...
    def getarguments(self, parser, subparsers):
        ...
        node_add.add_argument('-o', '--osimages', help='OS Image Name')
        ...
        node_add.add_argument('-sw', '--switchs', help='Switch Name')
        node_add.add_argument('-sp', '--switchport', help='Switch Port')
        node_add.add_argument('-pre', '--prescripts', action='store_true', help='Pre Script')
        ...
        node_add.add_argument('-N', '--networks', help='Interface Network Name')
        ...
        node_change.add_argument('-tid', '--tpm', help='TPM UUID')
        ...
        node_clone.add_argument('-pm', '--provision_methods', help='Provision Method')
        ...
        node_rename.add_argument('newnodesname', help='New Name for the Node')
        ...
        change_interface.add_argument('interfaces', help='Name of the Node Interface')
        change_interface.add_argument('-N', '--network', help='Network Name')
        change_interface.add_argument('-I', '--ipaddres', help='IP Address')
