...
class Secrets():
    ...
    def getarguments(self, parser, subparsers):
        ...
        list_node.add_argument('-s', '--secrets', help='Name of the Secret')
        ...
        change_node.add_argument('-c', '--contents', action='store_true',
        ...
        change_group.add_argument('-qc', '--quick-content', dest='content',
                                metavar="File-Path OR In-Line", help='Content File-Path OR In-Line')
        change_group.add_argument('--paths', '-p', help='Path of the Secret')
        ...
        change_group.add_argument('name', help='Name of the Group')
        change_group.add_argument('secrets', help='Name of the Secret')
        change_group.add_argument('--content', '-c', action='store_true',
                                  help='Content of the Secret')
        change_group.add_argument('-qc', '--quick-content', dest='content',
                                metavar="File-Path OR In-Line", help='Content File-Path OR In-Line')
        ...
        clone_node.add_argument('newsecret', help='New name for the Secret')
        ...
        remove_node.add_argument('secrets', help='Name of the Secret')
