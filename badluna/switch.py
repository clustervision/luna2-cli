...
class Switch():
    ...
    def getarguments(self, parser, subparsers):
        ...
        switch_add.add_argument('-N', '--networks', help='Network')
        switch_add.add_argument('-ip', '--ipaddr', help='IP Address')
        ...
        switch_change.add_argument('-r', '--reads', help='Read community')
        ...
        switch_clone.add_argument('-w', '--rws', help='Write community')
        switch_clone.add_argument('-o', '--oids', help='OID')
