...
class BMCSetup():
    ...
    def getarguments(self, parser, subparsers):
        ...
        bmcsetup_add.add_argument('-nt', '--netchannels', type=int, help='Network Channel')
        ...
        bmcsetup_change.add_argument('-mt', '--mgmtchannels', type=int, help='Management Channel')
        ...
        bmcsetup_clone.add_argument('-ubu', '--unmanaged_bmc_user', help='Unmanaged BMC Users')
        ...
        bmcsetup_rename.add_argument('newname', help='New BMC Setup Name')
