...
class OSImage():
    ...
    def getarguments(self, parser, subparsers):
        ...
        osimage_add.add_argument('-dm', '--dracutmodule', help='Dracut Modules')
        ...
        osimage_add.add_argument('-m', '--kernelmodule', help='Kernel Modules')
        ...
        osimage_change.add_argument('-k', '--kernel_file', help='Kernel File')
        osimage_change.add_argument('-m', '--kernel_modules', help='Kernel Modules')
        osimage_change.add_argument('-o', '--kernel_options', help='Kernel Options')
        ...
        osimage_clone.add_argument('-rd', '--initrd_file', help='INIT RD File')
        ...
        osimage_rename.add_argument('names', help='OSImage Name')
        ...
        osimage_kernel.add_argument('-ver', '--kernel_version', help='Kernel Version')
