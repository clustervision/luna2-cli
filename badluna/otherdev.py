...
class OtherDev():
    ...
    def getarguments(self, parser, subparsers):
        ...
        otherdev_add.add_argument('-N', '--networks', help='Network Name')
        ...
        otherdev_change.add_argument('-m', '--macaddres', help='MAC Address')
        ...
        otherdev_clone.add_argument('-c', '--comments', action='store_true', help='Comment')
        ...
        otherdev_rename.add_argument('newdevname', help='New Other Device Name')
