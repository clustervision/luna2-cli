...
class Service():
    ...
    def __init__(self, args=None, parser=None, subparsers=None):
        ...
        self.service = ['dhcp', 'dns', 'luna2', 'tuna', 'httpd']
        if self.args:
    ...
    def getarguments(self, parser, subparsers):
        ...
        dhcp = service_args.add_parser('tuna', help='tuna Service')
        dhcp_parser = dhcp.add_subparsers(dest='action')
        Helper().common_service_args(dhcp_parser, 'tuna')
        dhcp = service_args.add_parser('httpd', help='httpd Service')
        dhcp_parser = dhcp.add_subparsers(dest='action')
        Helper().common_service_args(dhcp_parser, 'httpd')
        return parser
