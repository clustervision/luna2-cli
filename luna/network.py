...
class Network():
    ...
    def get_arguments(self, parser, subparsers):
        ...
        network_change.add_argument('name', help='Network Name').completer = Helper().name_completer(self.table)
        ...
        network_rename.add_argument('name', help='Network Name').completer = Helper().name_completer(self.table)
        ...
        network_remove.add_argument('name', help='Network Name').completer = Helper().name_completer(self.table)
        ...
        network_taken.add_argument('name', help='Network Name').completer = Helper().name_completer(self.table)
        ...
        network_ipinfo.add_argument('name', help='Network Name').completer = Helper().name_completer(self.table)
        ...
        network_nextip.add_argument('name', help='Network Name').completer = Helper().name_completer(self.table)
