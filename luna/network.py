...
class Network():
    ...
    def getarguments(self, parser, subparsers):
        ...
        network_add.add_argument('-dhcp', '--dhcp', choices=Helper().boolean(), help='DHCP')
        ...
        network_add.add_argument('-c', '--comment', action='store_true', help='Comment for Network')
        ...
        network_change.add_argument('-dhcp', '--dhcp', choices=Helper().boolean(), help='DHCP')
        ...
        network_change.add_argument('-c', '--comment', action='store_true', help='Comment for Network')
        ...
        network_clone.add_argument('-dhcp', '--dhcp', choices=Helper().boolean(), help='DHCP')
        ...
        network_clone.add_argument('-c', '--comment', action='store_true', help='Comment for Network')
