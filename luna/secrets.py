...
class Secrets():
    ...
    def get_arguments(self, parser, subparsers):
        ...
        secrets_menu = subparsers.add_parser('secrets', help='Secrets operations.',
            description='Luna secrets stores data for groups and nodes in an\nencrypted way. Secrets is typically used to store keytabs,\ncertificates or other sensitive information that would\notherwise be stored inside the osimage.')
