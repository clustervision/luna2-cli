...
class Switch():
    ...
    def getarguments(self, parser, subparsers):
        ...
        Helper().common_switch_device_args(switch_add, 'Switch')
        ...
        Helper().common_switch_device_args(switch_update, 'Switch')
        ...
        Helper().common_switch_device_args(switch_clone, 'Switch')
