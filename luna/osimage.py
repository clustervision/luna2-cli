...
class OSImage():
    ...
    def get_arguments(self, parser, subparsers):
        ...
        """
        osimage_menu = subparsers.add_parser('osimage', help='OSImage operations.', description='This refers to changes and management of supported osimages within trinityX and to boot worker nodes.')
