...
class OtherDev():
    ...
    def get_arguments(self, parser, subparsers):
        ...
        otherdev_menu = subparsers.add_parser('otherdev', help='Other Devices operations.',
            description='Luna otherdev(ices) allows to add, change and '
                        'remove devices like cameras, PDU-s and UPS-es. '
                        'These devices will not be probed or accessed are '
                        'primarily there to complete a rack layout (pun) or '
