...
class Service():
    ...
    def get_arguments(self, parser, subparsers):
        ...
        """
        service_menu = subparsers.add_parser('service', help='Service operations.', description='Luna service allows to manually stop, start, restart and status services like dns and dhcp.')
