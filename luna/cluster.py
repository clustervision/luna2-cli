...
class Cluster():
    ...
    def get_arguments(self, parser, subparsers):
        ...
        cluster_menu = subparsers.add_parser('cluster', help='Cluster Information.', description='Luna cluster shows and alters cluster level configuration like DNS forwarders, provisioning method etc.')
