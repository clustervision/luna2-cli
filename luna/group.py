...
class Group():
    ...
    def getarguments(self, parser, subparsers):
        ...
        group_add.add_argument('-nb', '--netboot', choices=Helper().boolean(), help='Network Boot')
        ...
        group_change.add_argument('-b', '--setupbmc', choices=Helper().boolean(), help='BMC Setup')
        ...
        group_change.add_argument('-nb', '--netboot', choices=Helper().boolean(), help='Network Boot')
        ...
        group_clone.add_argument('-b', '--setupbmc', choices=Helper().boolean(), help='BMC Setup')
