...
class Control():
    ...
    def get_arguments(self, parser, subparsers):
        ...
        for action in actions('sel'):
            action_parser = sel_menu.add_parser(action, help=f'Node(s) {action.capitalize()}')
            action_parser.add_argument('-v', '--verbose', action='store_true', help='Verbose Mode')
            action_parser.add_argument('node', help='Node Name or Node Hostlist')
        ...
        for action in actions('chassis'):
            action_parser = chassis_menu.add_parser(action, help=f'Node(s) {action.capitalize()}')
            action_parser.add_argument('-v', '--verbose', action='store_true', help='Verbose Mode')
            action_parser.add_argument('node', help='Node Name or Node Hostlist')
        ...
        for action in actions('redfish'):
            action_parser = redfish_menu.add_parser(action, help=f'Node(s) {action.capitalize()}')
            action_parser.add_argument('-v', '--verbose', action='store_true', help='Verbose Mode')
            action_parser.add_argument('node', help='Node Name or Node Hostlist')
