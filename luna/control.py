...
class Control():
    ...
    def get_arguments(self, parser, subparsers):
        ...
        """
        control_menu = subparsers.add_parser('control', help='Control Nodes.', description='This is a Luna tool fully supporting the APIs. A separate tool named lpower also controls the nodes the same way as luna control.')
