...
class BMCSetup():
    ...
    def getarguments(self, parser, subparsers):
        ...
        bmcsetup_add.add_argument('-c', '--comment', action='store_true',
                                  help='Comment for BMC Setup')
        ...
        bmcsetup_change.add_argument('-c', '--comment', action='store_true',
                                     help='Comment for BMC Setup')
        ...
        bmcsetup_clone.add_argument('-c', '--comment', action='store_true',
                                    help='Comment for BMC Setup')
