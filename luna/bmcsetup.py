...
class BMCSetup():
    ...
    def get_arguments(self, parser, subparsers):
        ...
        """
        bmcsetup_menu = subparsers.add_parser('bmcsetup', help='BMC Setup operations.', description='Luna bmcsetup manages bmc or ipmi configurations through profiles. In here netchannels and passwords can be configured.')
